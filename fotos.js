...
//Springt in der Vollbild-Ansicht um n Bilder vor bzw. zurück
function plusSlides(n) {
    showSlides((slideIndex += n));
}

//Zeigt das Bild mit dem angegebenen Index n
...
//Auskommentiert, weil momentan kein expandButton vorhanden ist
/* function expand() {
    clickCounter++;
